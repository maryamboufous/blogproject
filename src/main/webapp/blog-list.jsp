...
<html>
<head>
<title>Blog Crud Operations JEE</title>
<link rel="stylesheet"
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				...
				class="navbar-brand"> Blog
					Crud Operations JEE </a>
			</div>
				...
				<tbody>
					...
					<c:forEach var="blog" items="${listBlog}">
						...
						<tr>
							...
							<td><c:out value="${blog.titre}" /></td>
							<td><c:out value="${blog.soustitre}" /></td>
							<td><c:out value="${blog.contenu}" /></td>
